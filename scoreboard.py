...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        self.score_image = self.front.render(score_str, True, self.text_color, self.settings.bg_color)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.front.render(high_score_str, True, self.text_color, self.settings.bg_color)
    ...
    def prep_level(self):
        ...
        self.level_image = self.front.render(level_str, True, self.text_color, self.settings.bg_color)
